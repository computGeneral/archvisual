...
# by a subsisting licensing agreement from lyj002286 limited.                 
#                 (c) Copyright 2024-2029 lyj002286 limited.                  
#                     ALL RIGHTS RESERVED                                 
# This entire notice must be reproduced on all copies of this file        
# and copies of this file may only be made by a person if such person is  
# permitted to do so under the terms of a subsisting license agreement    
# from lyj002286 limited.                                                     
# 
...
urlpatterns = [
    ...
    path('api/show/server_list', dataviewer.views.api_show_server_list),
    path('api/show/server_file', dataviewer.views.api_show_server_file),
